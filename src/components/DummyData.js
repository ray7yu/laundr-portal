...
export const userRows = [
    ...
    createUser('Bob Smith','bs@hi.com','12/23/2009'),
    createUser('Percival Williamson','percw@hi.com','1/3/2012'),
    createUser('Jason Taylor','jason@hi.com','3/30/2017'),
    createUser('Ada Jones','ada@hi.com','4/1/2018'),
    createUser('Tyler Jackson','tyj@hi.com','3/23/2000'),
    createUser('George Adams','george@hi.com','11/11/2011'),
    createUser('Isabella Ford','iford@hi.com','10/10/2010'),
    createUser('Samuel McAdams','samcadams@hi.com','12/12/2012'),
    createUser('Melvin Fisher','melvin@hi.com','07/26/2019'),
    createUser('Autumn Hood','autumn@hi.com','08/18/2016'),
    createUser('Charlie Roth','charlie@hi.com','7/30/2008'),
    createUser('Chase Hughes','chase@hi.com','5/6/2016'),
    createUser('Wayne Morrison','wayne@hi.com','3/16/2005'),
    createUser('Ryan Myers','ryan@hi.com','3/10/2020'),
    createUser('John Lynn','johnlynn@hi.com','8/19/2013'),
    createUser('Bianca Howard','bianca@hi.com','7/2/2002'),
    createUser('Eli Whittaker','eli@hi.com','3/1/2019'),
    createUser('Stephen Brown','steph@hi.com','8/19/2018'),
    createUser('Jeff Martin','jeff@hi.com','5/8/2015'),
    ];
