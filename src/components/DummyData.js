...
export const orderRows = [
    createOrder(1,12,new Date(2020,9,26,14,32),new Date(2020,9,26,16,21),'Gideon Waters','4000 SW 23rd ST APT 4-306','Paid', 4),
    createOrder(2,12,new Date(2020,9,22,14,2),new Date(2020,9,22,20,32),'Kareena Head','866 North Grandrose Dr. Harleysville, PA 19438','Pending',20),
    createOrder(101,1235,new Date(2020,9,26,1,58),new Date(2020,9,26,3,22),'Phoebe McCartney','7 East Amherst Street Defiance, OH 43512','Pending',1.2),
    createOrder(3,18675,new Date(2020,9,25,23,10),new Date(2020,9,26,3,7),'Issa Spencer','9496 Selby Ave. Deerfield Beach, FL 33442','Paid',4.5),
    createOrder(23,128,new Date(2020,9,23,23,3),new Date(2020,9,23,23,27),'Sierra Mackenzie','943 Smith Store Lane Brownsburg, IN 46112','Pending',15.3)
    ...
    // createOrder(1,12,new Date(2020,8,26,14,32),new Date(2020,8,26,16,21),'Gideon Waters','4000 SW 23rd ST APT 4-306',4,'Paid'),
    // createOrder(2,12,new Date(2020,8,22,14,2),new Date(2020,8,22,20,32),'Kareena Head','866 North Grandrose Dr. Harleysville, PA 19438',20,'Pending'),
    // createOrder(101,1235,new Date(2020,8,26,1,58),new Date(2020,8,26,3,22),'Phoebe McCartney','7 East Amherst Street Defiance, OH 43512',1.2,'Pending'),
    // createOrder(3,18675,new Date(2020,8,25,23,10),new Date(2020,8,26,3,7),'Issa Spencer','9496 Selby Ave. Deerfield Beach, FL 33442',4.5,'Paid'),
    // createOrder(23,128,new Date(2020,8,23,23,3),new Date(2020,8,23,23,27),'Sierra Mackenzie','943 Smith Store Lane Brownsburg, IN 46112',15.3,'Pending'),
    // createOrder(153,123,new Date(2020,8,20,8,40),new Date(2020,8,20,11,23),'Chance Salas','605 Newbridge Dr. Fairborn, OH 45324',2.3,'Paid'),
    // createOrder(23,5321,new Date(2020,8,23,9,3),new Date(2020,8,23,10,2),'Tiffany Dowling','96 Old Oakland Street Mahwah, NJ 07430',1.3,'Paid'),
    // createOrder(5,23197,new Date(2020,8,24,4,0),new Date(2020,8,25,0,48),'Edison Dunn','7914 Orchard R. Ft. Mitchell, KY 41017',3,'Paid'),
    // createOrder(92,2334,new Date(2020,8,22,12,15),new Date(2020,8,22,15,5),'Edison Dunn','35 Euclid Lane Waterloon, IA 50701',1.2,'Paid'),
    // createOrder(23,23487,new Date(2020,8,14,0,12),new Date(2020,8,14,1,22),'Marian McNeill','6 North Highland Springfield Gardens, NY 11412',1,'Pending'),
    // createOrder(123,23489,new Date(2020,8,23,20,30),new Date(2020,8,23,21,5),'Rayan Bostock','795 Cemetery Street Oak Forest, IL 60452',5.7,'Pending'),
    // createOrder(89,23478,new Date(2020,8,21,1,59),new Date(2020,8,21,23,50),'Jayden-Lee Jordan','8893 Lakeview Street Lilburn, GA 30047',3.2,'Paid'),
    // createOrder(10,3243,new Date(2020,8,23,19,3),new Date(2020,8,23,21,26),'Geoffrey Merrill','12 Hillcrest Drive Mooresville, NC 28115',10,'Paid'),
    // createOrder(17,23487,new Date(2020,8,22,14,21),new Date(2020,8,23,4,2),'Mahir Raymond','8109 St. Paul Ave. Dallas, GA 30132',7,'Paid'),
    // createOrder(17,23487,new Date(2020,8,28,14,21),new Date(2020,8,28,4,2),'Mahir Raymond','8109 St. Paul Ave. Dallas, GA 30132',20,'Paid'),
    // createOrder(23,128,new Date(2020,8,23,23,3),new Date(2020,8,23,23,27),'Sierra Mackenzie','943 Smith Store Lane Brownsburg, IN 46112',13,'Pending'),
    // createOrder(153,123,new Date(2020,8,20,8,40),new Date(2020,8,20,11,23),'Chance Salas','605 Newbridge Dr. Fairborn, OH 45324',20.3,'Paid'),
    // createOrder(23,5321,new Date(2020,8,23,9,3),new Date(2020,8,23,10,2),'Tiffany Dowling','96 Old Oakland Street Mahwah, NJ 07430',12.3,'Paid'),
    // createOrder(5,23197,new Date(2020,8,24,4,0),new Date(2020,8,25,0,48),'Edison Dunn','7914 Orchard R. Ft. Mitchell, KY 41017',3,'Paid'),
    // createOrder(92,2334,new Date(2020,8,22,12,15),new Date(2020,8,22,15,5),'Edison Dunn','35 Euclid Lane Waterloon, IA 50701',1,'Paid'),
    // createOrder(23,23487,new Date(2020,8,14,0,12),new Date(2020,8,14,1,22),'Marian McNeill','6 North Highland Springfield Gardens, NY 11412',12.3,'Pending'),
    // createOrder(123,23489,new Date(2020,8,23,20,30),new Date(2020,8,23,21,5),'Rayan Bostock','795 Cemetery Street Oak Forest, IL 60452',34.7,'Pending'),
    // createOrder(89,23478,new Date(2020,8,21,1,59),new Date(2020,8,21,23,50),'Jayden-Lee Jordan','8893 Lakeview Street Lilburn, GA 30047',3.2,'Paid'),
